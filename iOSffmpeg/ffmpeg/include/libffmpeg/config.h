...
#define FFMPEG_CONFIGURATION "--disable-gpl --disable-nonfree --enable-runtime-cpudetect --disable-gray --disable-swscale-alpha --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --enable-avdevice --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --disable-postproc --enable-avfilter --disable-avresample --enable-network --disable-d3d11va --disable-dxva2 --disable-vaapi --disable-vdpau --disable-videotoolbox --disable-encoders --enable-encoder=png --disable-decoders --enable-decoder=aac --enable-decoder=aac_latm --enable-decoder=flv --enable-decoder=h264 --enable-decoder='mp3*' --enable-decoder=vp6f --enable-decoder=flac --enable-decoder=hevc --enable-decoder=vp8 --enable-decoder=vp9 --enable-decoder=pcm_alaw --enable-decoder=pcm_mulaw --disable-hwaccels --enable-hwaccel=h264_vaapi --enable-hwaccel=h264_dxva2 --disable-muxers --enable-muxer=mp4 --enable-muxer=mov --disable-demuxers --enable-demuxer=aac --enable-demuxer=concat --enable-demuxer=data --enable-demuxer=flv --enable-demuxer=hls --enable-demuxer=live_flv --enable-demuxer=mov --enable-demuxer=mp3 --enable-demuxer=mpegps --enable-demuxer=mpegts --enable-demuxer=mpegvideo --enable-demuxer=flac --enable-demuxer=hevc --enable-demuxer=webm_dash_manifest --enable-demuxer=rtsp --enable-demuxer=sdp --enable-demuxer=rtp --enable-decoder=mjpeg --enable-demuxer=mjpeg --enable-demuxer=h264 --disable-parsers --enable-parser=aac --enable-parser=aac_latm --enable-parser=h264 --enable-parser=flac --enable-parser=hevc --enable-bsfs --disable-bsf=chomp --disable-bsf=dca_core --disable-bsf=dump_extradata --disable-bsf=hevc_mp4toannexb --disable-bsf=imx_dump_header --disable-bsf=mjpeg2jpeg --disable-bsf=mjpega_dump_header --disable-bsf=mov2textsub --disable-bsf=mp3_header_decompress --disable-bsf=mpeg4_unpack_bframes --disable-bsf=noise --disable-bsf=remove_extradata --disable-bsf=text2movsub --disable-bsf=vp9_superframe --disable-bsf=eac3_core --enable-protocols --enable-protocol=async --disable-protocol=bluray --disable-protocol=concat --disable-protocol=crypto --disable-protocol=ffrtmpcrypt --enable-protocol=ffrtmphttp --disable-protocol=gopher --disable-protocol=icecast --disable-protocol='librtmp*' --disable-protocol=libssh --disable-protocol=md5 --disable-protocol=mmsh --disable-protocol=mmst --enable-protocol='rtmp*' --enable-protocol=rtmp --enable-protocol=rtmpt --enable-protocol=rtp --disable-protocol=sctp --disable-protocol=srtp --disable-protocol=subfile --disable-protocol=unix --enable-protocol=tcp --enable-protocol=udp --disable-devices --disable-filters --disable-iconv --enable-audiotoolbox --enable-videotoolbox --disable-linux-perf --disable-bzlib --enable-cross-compile --disable-stripping --arch=arm64 --target-os=darwin --enable-static --disable-shared --enable-pic --enable-neon --enable-optimizations --enable-debug --enable-small --prefix=/Users/keithxi/Documents/TMP/OC/ijkplayer-lab/ios/build/ffmpeg-arm64/output --cc='xcrun -sdk iphoneos clang' --extra-cflags=' -arch arm64 -miphoneos-version-min=11.0 -fembed-bitcode' --extra-cxxflags=' -arch arm64 -miphoneos-version-min=11.0 -fembed-bitcode' --extra-ldflags=' -arch arm64 -miphoneos-version-min=11.0 -fembed-bitcode '"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2018
#define FFMPEG_DATADIR "/Users/keithxi/Documents/TMP/OC/ijkplayer-lab/ios/build/ffmpeg-arm64/output/share/ffmpeg"
#define AVCONV_DATADIR "/Users/keithxi/Documents/TMP/OC/ijkplayer-lab/ios/build/ffmpeg-arm64/output/share/ffmpeg"
